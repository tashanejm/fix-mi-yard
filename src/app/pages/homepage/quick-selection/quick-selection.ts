...
export class QuickSelection extends Base {
  ...
  private computeSelections(): void {
    this.selections = computed(() => {
      ...
      const items = [
        { key: 'handyPerson', id: 'handy-person', label: 'common.actions.handyperson', icon: this.materialSymbols.HANDYMAN },
        { key: 'landscaping', id: 'landscaping', label: 'common.actions.landscaping', icon: this.materialSymbols.GRASS },
        { key: 'plumbing', id: 'plumbing', label: 'common.actions.plumbing', icon: this.materialSymbols.PLUMBING },
        { key: 'electrical', id: 'electrical', label: 'common.actions.electrical', icon: this.materialSymbols.ELECTRICAL_SERVICES },
        { key: 'cleaning', id: 'cleaning', label: 'common.actions.cleaning', icon: this.materialSymbols.CLEANING_SERVICES },
        ...
        { key: 'remodeling', id: 'remodeling', label: 'common.actions.remodeling', icon: this.materialSymbols.HOME_REPAIR_SERVICE },
